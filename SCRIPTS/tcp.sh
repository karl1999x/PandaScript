...
clear
msg -bar3
echo -e " TCP Aceleración (BBR/Plus) ADMcgh By @ChumoGH ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}"
msg -bar3
echo -e "${Green_font_prefix}0.${Font_color_suffix} Script de actualización
————————————Gestión del Núcleo————————————
...
————————————Manejo misceláneo————————————
 ...
 ${Green_font_prefix}10.${Font_color_suffix} Optimización de la configuración del sistema [ RECOMENDADO ].
