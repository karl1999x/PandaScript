#!/bin/bash
source <(curl -sL https://raw.githubusercontent.com/joaquin1444/MOD-V6/refs/heads/main/script-v6/Otros/msg)
...
wget -q -O proxy3.js https://raw.githubusercontent.com/karl1999x/PandaScript/main/javascript/proxy3.js
...
wget -O httpsProxy.js -q https://raw.githubusercontent.com/karl1999x/PandaScript/main/javascript/proxy3.js
